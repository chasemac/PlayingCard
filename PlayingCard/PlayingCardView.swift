...
class PlayingCardView: UIView {
    ...
    var faceCardScale: CGFloat =  SizeRatio.faceCardImageSizeToBounds { didSet { setNeedsDisplay() }}
    ...
    override func draw(_ rect: CGRect) {
        let roundedRext = UIBezierPath(roundedRect: bounds, cornerRadius: cornerRadius)
        roundedRext.addClip()
